...
pub(crate) use egui_phosphor::regular::{
    ...
    CLOCK_CLOCKWISE, COMPASS, DISC, DROP, EAR, EQUALIZER, FADERS, FAST_FORWARD, GAUGE, LIGHTNING,
    MAGNIFYING_GLASS, MICROPHONE, MICROPHONE_STAGE, MONITOR, MUSIC_NOTE, MUSIC_NOTES, PAUSE, PLAY,
    PLAYLIST, REWIND, SKIP_BACK, SKIP_FORWARD, SPARKLE, SPEAKER_HIGH, SPEAKER_SLASH, STOP, SWAP,
    TRASH_SIMPLE, WAVEFORM, WIND, WRENCH,
};
