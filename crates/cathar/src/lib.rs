...
impl AudioData {
    pub fn from_file(path: &str) -> Result<Self, Error> {
        ...
        let sample_rate = track.codec_params.sample_rate.ok_or(Error::UnsupportedFormat)?;
        let num_channels = track.codec_params.channels.ok_or(Error::UnsupportedFormat)?.count();
